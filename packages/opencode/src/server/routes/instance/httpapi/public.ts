...
import { matchLegacyKiloOpenApi, normalizeProviderConfig } from "@/kilocode/server/httpapi/public"
...
function applyLegacySchemaOverrides(spec: OpenApiSpec) {
  ...
  normalizeProviderConfig(schemas.ProviderConfig) // kilocode_change - Plus: preserve custom provider delete sentinels in SDK schemas
