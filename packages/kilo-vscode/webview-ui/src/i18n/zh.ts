...
export const dict = {
  ...
  "provider.custom.field.name.placeholder": "会按该名称分组",
  ...
  "provider.custom.models.image.label": "图片支持",
  ...
  "provider.custom.models.outputLimit.placeholder": "最大输出 token",
  "provider.custom.models.cost.label": "成本选项",
  "provider.custom.models.inputCost.label": "输入成本 ($/1M)",
  "provider.custom.models.outputCost.label": "输出成本 ($/1M)",
  "provider.custom.models.cacheReadCost.label": "缓存读取 ($/1M)",
  "provider.custom.models.cacheWriteCost.label": "缓存写入 ($/1M)",
  "provider.custom.models.cost.placeholder": "例如 3.00",
  "provider.custom.models.reasoning.label": "推理支持",
  ...
  "provider.custom.models.fetch.privateHost": "此次模型发现请求会访问本机或内网地址。请仅对可信提供商继续操作。",
  ...
  "provider.custom.models.defaults.title": "候选模型列表",
  "provider.custom.models.defaults.description": "没有找到 {{id}} 的精确默认参数。请选择一个近似模型来复制参数。",
  ...
  "provider.custom.error.tokenLimit": "请输入大于 0 的整数",
  "provider.custom.error.cost": "请输入大于或等于 0 的数字",
