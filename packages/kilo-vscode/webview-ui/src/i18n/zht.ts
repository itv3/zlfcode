...
export const dict = {
  ...
  "provider.custom.field.name.placeholder": "會按該名稱分組",
  "provider.custom.field.package.label": "Provider API",
  "provider.custom.field.baseURL.label": "BASE_URL",
  "provider.custom.field.baseURL.placeholder": "https://api.myprovider.com/v1",
  "provider.custom.field.apiKey.label": "API_KEY",
  "provider.custom.field.apiKey.placeholder": "選填，使用標頭驗證時留空",
  "provider.custom.field.apiKey.placeholder.saved": "已儲存，留空則保留；輸入新 KEY 則替換",
  "provider.custom.field.apiKey.description": "選填。如果您透過標頭管理驗證，請留空。",
  "provider.custom.field.websocket.label": "啟用 WebSocket",
  "provider.custom.field.websocket.description":
    "需要服務端支援 OpenAI Responses WebSocket；失敗時依內建重試策略回退 HTTP。",
  ...
  "provider.custom.models.image.label": "圖片支援",
  "provider.custom.models.contextLimit.label": "limit.context",
  "provider.custom.models.contextLimit.placeholder": "上下文 token 上限",
  "provider.custom.models.outputLimit.label": "limit.output",
  "provider.custom.models.outputLimit.placeholder": "最大輸出 token",
  "provider.custom.models.reasoning.label": "推理支援",
  "provider.custom.models.cost.label": "成本選項",
  "provider.custom.models.inputCost.label": "輸入成本",
  "provider.custom.models.outputCost.label": "輸出成本",
  "provider.custom.models.cacheReadCost.label": "快取讀取成本",
  ...
  "provider.custom.models.variants.reasoningEffort.max": "max",
  ...
  "provider.custom.models.defaults.title": "候選模型列表",
  "provider.custom.models.defaults.description": "沒有找到 {{id}} 的精確預設參數。請選擇一個近似模型來複製參數。",
  "provider.custom.models.defaults.yes": "是",
  "provider.custom.models.defaults.no": "否",
  ...
  "provider.custom.error.tokenLimit": "請輸入正整數 token 上限",
  "provider.custom.error.cost": "請輸入大於或等於 0 的數字",
  ...
  "workStyle.toast.saved.action": "前往設定",
  ...
  "agent.description.ask": "回答問題並提供解釋，不會修改程式碼庫。",
  ...
  "settings.indexing.projectEnable.disabledTooltip": "全域索引已啟用，目前專案已包含在內。",
