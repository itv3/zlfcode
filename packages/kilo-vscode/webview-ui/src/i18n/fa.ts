...
export const dict = {
  ...
  // kilocode_change: ZLF 自有的自定义提供商 WebSocket 开关键；上游 v7.4.18 新增
  // fa 语言时不含 ZLF 键，合并 v7.4.20 时补齐。
  "provider.custom.field.websocket.label": "فعال‌سازی WebSocket",
  "provider.custom.field.websocket.description":
    "به پشتیبانی OpenAI Responses WebSocket نیاز دارد. در صورت خطا، طبق سیاست تلاش مجدد داخلی به HTTP بازمی‌گردد.",
