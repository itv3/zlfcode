...
export const dict = {
  ...
  "provider.custom.field.name.placeholder": "Groups by this name",
  ...
  "provider.custom.models.image.label": "Image support",
  "provider.custom.models.contextLimit.label": "limit.context",
  "provider.custom.models.contextLimit.placeholder": "Context token limit",
  "provider.custom.models.outputLimit.label": "limit.output",
  "provider.custom.models.outputLimit.placeholder": "Max output tokens",
  "provider.custom.models.cost.label": "Cost options",
  "provider.custom.models.inputCost.label": "Input cost ($/1M)",
  "provider.custom.models.outputCost.label": "Output cost ($/1M)",
  "provider.custom.models.cacheReadCost.label": "Cache read ($/1M)",
  "provider.custom.models.cacheWriteCost.label": "Cache write ($/1M)",
  "provider.custom.models.cost.placeholder": "e.g. 3.00",
  "provider.custom.models.reasoning.label": "Reasoning support",
  ...
  "provider.custom.models.fetch.privateHost":
    "This model discovery request targets a local or private network address. Continue only for providers you trust.",
  ...
  "provider.custom.error.tokenLimit": "Enter a whole number greater than 0",
  "provider.custom.error.cost": "Enter a number greater than or equal to 0",
  ...
  "session.messages.welcome":
    "ZLF Code is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
