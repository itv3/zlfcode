...
这是面向内部使用的 AI coding agent，基于上游 Kilo Code 的非官方 fork 定制，主要增强自定义提供商能力。

发布批次：`7.4.1-v0.03`

市场版本：`7.4.103`

含义：基于上游 Kilo Code `7.4.1`，ZLF 自定义版本 `v0.03`。
...
| 默认参数匹配 | 添加模型时优先用模型 ID 精确匹配内置默认模型；未命中时显示候选模型列表供用户选择近似模型。 |
